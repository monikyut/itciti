...
<div class="content">
	<div id="homepage" class="content-homepage">
		<!--flash-->
		<div class="bg-img">
			<img src="resources/background.png" width="100%">
		</div>
	</div>
	<div id="about" class="pure-g-r content-about">
		<div class="pure-u-1">
			<h3>About Us</h3>
			<blockquote>
	...
	<!--<div class="bg-img-about">
		<img src="resources/bg.png" width="500px" height="500px" />
	</div>-->
	<div id="services" class="pure-g-r content-services">
		<div class="pure-u-1">
		<h3>IT CONSULTING</h3>
			<div class="pure-g-r">
	...
	<div id="careers" class="content-careers">
		<div class="pure-g-r">
			...
			<div class="pure-u-1-3">
				<!--gap between header and search-->
			</div>
			<div class="pure-u-1-3 job-search">
				<div class="pure-form">
